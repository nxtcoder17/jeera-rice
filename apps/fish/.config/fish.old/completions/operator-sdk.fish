...
function __operator_sdk_prepare_completions
    ...
    set -l results (__operator_sdk_perform_completion)
    __operator_sdk_debug "Completion results: $results"
    ...
    set --global __operator_sdk_comp_results $results[1..-2]
...
complete -c operator-sdk -n '__operator_sdk_prepare_completions' -f -a '$__operator_sdk_comp_results'
