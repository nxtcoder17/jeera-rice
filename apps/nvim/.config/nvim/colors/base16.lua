...
local theme = lib.Theme(palette):set_hl_groups(function(p)
	...
	lib.hl("Keyword", { fg = lib.reverse_blend(p.base09, 40) })
	lib.hl("Number", { link = "Keyword" })
	lib.hl("Structure", { fg = lib.reverse_blend(p.base09, 40) })
	lib.hl("Tag", { fg = lib.reverse_blend(p.base0A, 40) })
	...
	lib.hl("MatchParen", { bg = lib.blend(p.base02, 20), fg = lib.reverse_blend(p.base02, 60) })
