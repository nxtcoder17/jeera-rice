...
function M.symbols(dir, query)
  ...
  local shortcuts = dir and "ctrl-f: funcs | ctrl-t: types | ctrl-c: consts"
    or "ctrl-f: funcs | ctrl-t: types | ctrl-c: consts | ctrl-p: packages | ctrl-d: deps"
  ...
  fzf.fzf_exec(build_cmd(cwd, patterns.all, include_stdlib), {
    ...
    actions = {
      ...
      ["ctrl-f"] = function(_, opts)
        M.functions(dir, get_query(opts))
      end,
      ["ctrl-t"] = function(_, opts)
        M.types(dir, get_query(opts))
      end,
      ["ctrl-c"] = function(_, opts)
        M.constants(dir, get_query(opts))
      end,
      ["ctrl-p"] = not dir and function(_, opts)
        M.packages(get_query(opts))
      end or nil,
      ["ctrl-d"] = not dir and function(_, opts)
        M.dep_packages(get_query(opts))
      end or nil,
    },
  })
end
  ...
  fzf.fzf_exec(items, {
    ...
    actions = {
      ...
      ["ctrl-a"] = function(_, opts)
        M.dep_symbols(get_query(opts))
      end,
      ["ctrl-f"] = function(_, opts)
        M.dep_functions(get_query(opts))
      end,
      ["ctrl-t"] = function(_, opts)
        M.dep_types(get_query(opts))
      end,
      ["ctrl-c"] = function(_, opts)
        M.dep_constants(get_query(opts))
      end,
      ["ctrl-w"] = function(_, opts)
        M.functions(nil, get_query(opts))
      end,
    },
  })
end
...
function M.dep_package_symbols(dep_path, dep_dir)
  ...
  fzf.fzf_exec(build_single_dep_cmd(dep_dir, dep_path, patterns.all), {
    ...
    actions = {
      ...
      ["ctrl-y"] = make_yank_action(),
      ["ctrl-f"] = function()
        M.dep_package_functions(dep_path, dep_dir)
      end,
      ["ctrl-t"] = function()
        M.dep_package_types(dep_path, dep_dir)
      end,
      ["ctrl-c"] = function()
        M.dep_package_constants(dep_path, dep_dir)
      end,
      ["ctrl-p"] = function()
        M.dep_packages()
      end,
...
function M.packages(query)
  ...
  fzf.fzf_exec(items, {
    ...
    actions = {
      ...
      ["ctrl-a"] = function(_, opts)
        M.symbols(nil, get_query(opts))
      end,
      ["ctrl-f"] = function(_, opts)
        M.functions(nil, get_query(opts))
      end,
      ["ctrl-t"] = function(_, opts)
        M.types(nil, get_query(opts))
      end,
      ["ctrl-c"] = function(_, opts)
        M.constants(nil, get_query(opts))
      end,
      ["ctrl-s"] = function(_, opts)
        M.stdlib_packages(get_query(opts))
      end,
    },
  })
end
...
function M.package_symbols(pkg_path, pkg_dir)
  ...
  fzf.fzf_exec(build_single_dep_cmd(pkg_dir, pkg_path, patterns.all), {
    ...
    actions = {
      ...
      ["ctrl-y"] = make_yank_action(),
      ["ctrl-f"] = function()
        M.package_functions(pkg_path, pkg_dir)
      end,
      ["ctrl-t"] = function()
        M.package_types(pkg_path, pkg_dir)
      end,
      ["ctrl-c"] = function()
        M.package_constants(pkg_path, pkg_dir)
      end,
      ["ctrl-p"] = function()
        M.packages()
      end,
...
function M.stdlib_packages(query)
  ...
  fzf.fzf_exec(items, {
    ...
    actions = {
      ...
      ["ctrl-a"] = function(_, opts)
        M.stdlib_symbols(get_query(opts))
      end,
      ["ctrl-f"] = function(_, opts)
        M.stdlib_functions(get_query(opts))
      end,
      ["ctrl-t"] = function(_, opts)
        M.stdlib_types(get_query(opts))
      end,
      ["ctrl-p"] = function(_, opts)
        M.packages(get_query(opts))
      end,
    },
  })
...
function M.stdlib_symbols(query)
  ...
  fzf.fzf_exec(build_stdlib_cmd(patterns.all), {
    ...
    actions = {
      ...
      ["ctrl-c"] = function(_, opts)
        M.stdlib_constants(get_query(opts))
      end,
      ["ctrl-p"] = function(_, opts)
        M.stdlib_packages(get_query(opts))
      end,
...
function M.functions(dir, query)
  ...
  local include_stdlib = not dir
  local effective_query = query or get_query_at_cursor()
  local shortcuts = dir and "ctrl-a: all | ctrl-t: types | ctrl-c: consts"
    or "ctrl-a: all | ctrl-t: types | ctrl-c: consts | ctrl-p: packages | ctrl-d: deps"
...
function M.types(dir, query)
  ...
  local include_stdlib = not dir
  local effective_query = query or get_query_at_cursor()
  local shortcuts = dir and "ctrl-a: all | ctrl-f: funcs | ctrl-c: consts"
    or "ctrl-a: all | ctrl-f: funcs | ctrl-c: consts | ctrl-p: packages | ctrl-d: deps"
...
function M.constants(dir, query)
  ...
  local include_stdlib = not dir
  local effective_query = query or get_query_at_cursor()
  local shortcuts = dir and "ctrl-a: all | ctrl-f: funcs | ctrl-t: types"
    or "ctrl-a: all | ctrl-f: funcs | ctrl-t: types | ctrl-p: packages | ctrl-d: deps"
