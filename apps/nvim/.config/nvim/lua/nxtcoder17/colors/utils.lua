-- INFO: shamelessly stolen from https://github.com/EdenEast/nightfox.nvim/blob/main/lua/nightfox/lib/color.lua

-- [source](https://github.com/EdenEast/nightfox.nvim/blob/main/lua/nightfox/util/init.lua)
